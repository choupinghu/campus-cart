            ...
            {listings.length === 0 ? (
                ...
                <div className="space-y-4">
                    {listings.map((listing) => (
                        <div key={listing.id} className="flex gap-6 bg-white rounded-2xl border border-gray-100 p-5 shadow-sm hover:shadow-md transition">
                            {/* Image */}
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-gray-500 mt-1 line-clamp-2">{listing.description || 'No description'}</p>
                                <div className="flex items-center gap-4 mt-3">
                                    <span className="text-lg font-bold text-nus-blue">S${listing.price.toFixed(2)}</span>
