...
export default function ProductCard({ product }) {
  ...
  const cardClasses =
    'flex flex-col overflow-hidden bg-white group cursor-pointer h-full no-underline'
      ...
      <div className="relative aspect-square w-full rounded-2xl bg-gray-50 overflow-hidden mb-4">
        ...
        {!isCampusCart && (
          <div className="absolute top-3 right-3 z-10 opacity-0 group-hover:opacity-100 transition-opacity">
            <span className="bg-white/95 backdrop-blur-sm p-1.5 rounded-full shadow-sm flex items-center justify-center">
